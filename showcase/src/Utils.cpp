...
// ZERO material - ambient, diffuse, specular, and shininess
float* Utils::zeroAmbient() { static float a[4] = { 0.5f, 0.5f, 0.5f, 1 }; return (float*)a; }
float* Utils::zeroDiffuse() { static float a[4] = { 0.5f, 0.5f, 0.5f, 1 }; return (float*)a; }
float* Utils::zeroSpecular() { static float a[4] = { 0.5f, 0.5f, 0.5f, 1 }; return (float*)a; }
float Utils::zeroShininess() { return 1.0f; }